...
public class SpringRestClientDataFeeder {
    ...
    private static final String GET_REWARDPOINT_ENDPOINT_URL = "http://localhost:8080/api/v1/rewards/{customerId}?fromMonth={fromMonth}";
    ...
    public static void main(String[] args) {
		...
		springRestClientDataFeeder.createOrderDetail("2", new BigDecimal(120));
        springRestClientDataFeeder.getRewardPointByCustomerId("2", "3");

    }

    private void getRewardPointByCustomerId(String customerId, String rewardStartMonth) {
        Map<String, String> params = new HashMap<String, String>();
        params.put("customerId", customerId);
        params.put("fromMonth", rewardStartMonth);
        ResponseEntity<RewardResponseDTO> result = restTemplate.getForEntity(GET_REWARDPOINT_ENDPOINT_URL,
                RewardResponseDTO.class,params);
